...
class InternetMessageHeader extends ComplexProperty {
    ...
    ReadAttributesFromXml(reader: EwsServiceXmlReader): any { throw new Error("InternetMessageHeader.ts - ReadAttributesFromXml : Not implemented."); }
    ReadTextValueFromXml(reader: EwsServiceXmlReader): any { throw new Error("InternetMessageHeader.ts - ReadTextValueFromXml : Not implemented."); }
