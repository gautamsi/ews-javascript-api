...
class NormalizedBody extends ComplexProperty {
    ...
    ReadAttributesFromXml(reader: EwsServiceXmlReader): any { throw new Error("NormalizedBody.ts - ReadAttributesFromXml : Not implemented."); }
    ReadTextValueFromXml(reader: EwsServiceXmlReader): any { throw new Error("NormalizedBody.ts - ReadTextValueFromXml : Not implemented."); }
