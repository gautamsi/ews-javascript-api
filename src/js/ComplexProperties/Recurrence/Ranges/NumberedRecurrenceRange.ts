...
class NumberedRecurrenceRange extends RecurrenceRange {
    ...
    TryReadElementFromXmlJsObject(reader: EwsServiceXmlReader): boolean { throw new Error("NumberedRecurrenceRange.ts - TryReadElementFromXmlJsObject : Not implemented."); }
