...
export class DayOfTheWeekCollection extends ComplexProperty {
    ...
    LoadFromXmlJsObject(jsonProperty: JsonObject, service: ExchangeService): void { throw new Error("DayOfTheWeekCollection.ts - LoadFromXmlJsObject : Not implemented."); }
