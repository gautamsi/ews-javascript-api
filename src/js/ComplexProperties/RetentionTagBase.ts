...
import EwsServiceXmlWriter = require("../Core/EwsServiceXmlWriter");
    ...
    class RetentionTagBase extends ComplexProperty {
        ...
        ReadAttributesFromXml(reader: EwsServiceXmlReader): any { throw new Error("RetentionTagBase.ts - ReadAttributesFromXml : Not implemented."); }
        ReadTextValueFromXml(reader: EwsServiceXmlReader): any { throw new Error("RetentionTagBase.ts - ReadTextValueFromXml : Not implemented."); }
