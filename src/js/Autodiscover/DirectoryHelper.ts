import ExchangeServiceBase = require("../Core/ExchangeServiceBase");
    export class DirectoryHelper {
        ...
        GetAutodiscoverScpUrlsForDomain(domainName: string): string[]{ throw new Error("Not implemented.");}
        GetScpUrlList(domainName: string, ldapPath: string, maxHops: any): string[]{ throw new Error("Not implemented.");}
