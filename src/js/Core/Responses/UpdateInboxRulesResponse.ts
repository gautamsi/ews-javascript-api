...
export class UpdateInboxRulesResponse extends ServiceResponse {
	...
	LoadExtraErrorDetailsFromXmlJsObject(reader: EwsServiceXmlReader, xmlElementName: string): boolean{ throw new Error("UpdateInboxRulesResponse.ts - LoadExtraErrorDetailsFromXml : Not implemented.");}
}