...
module Microsoft.Exchange.WebServices.Autodiscover {
    export class AutodiscoverService extends Data.ExchangeServiceBase {
        ...
        private static MinimumRequestVersionForAutoDiscoverSoapService: Data.ExchangeVersion = Data.ExchangeVersion.Exchange2010;


        constructor(
            url: string,
            domain: string,
            requestedServerVersion: Data.ExchangeVersion) {
            super(requestedServerVersion);

            Data.EwsUtilities.ValidateDomainNameAllowNull(domain, "domain");
