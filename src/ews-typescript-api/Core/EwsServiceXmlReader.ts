module Microsoft.Exchange.WebServices.Data {
    ...
    export class EwsServiceXmlReader extends EwsXmlReader {
        ...
        ReadServiceObjectsCollectionFromXml<TServiceObject>(collectionXmlElementName: string, getObjectInstanceDelegate: GetObjectInstanceDelegate<TServiceObject>, clearPropertyBag: boolean, requestedPropertySet: PropertySet, summaryPropertiesOnly: boolean, collectionXmlNamespace: XmlNamespace = XmlNamespace.Messages): TServiceObject[] /*System.Collections.Generic.List<T>*/ { throw new Error("Not implemented."); }
    }
